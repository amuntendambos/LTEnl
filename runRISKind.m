function S=runRISKind(S,rand_flag)
  ...
  for i=ns:Nv
      ...
      for j=1:Ne
          ...
          % alternative for getting maximum probability of damage/nuisance:
          pgv_n=GMPE(Re(Ii,:),M(Ii,:),dep(j),vs30(Ii,:),dGM,   -1,GMPEflag,ZE)*dSA*0.01;     % [Ng(In) Nm]
          pgv_d=GMPE(Re(Ii,:),M(Ii,:),dep(j),vs30(Ii,:),dGM,   -1,GMPEflag,ZE)*dSA*10;       % [Ng(Id) Nm]
          ...
          Nn2=On2;Nn3=On3;Nn4=On4;Nn5=On5;Nn6=On6;Nd1=Od1;Nd2=Od2; % alternative for getting maximum probability of damage/nuisance
